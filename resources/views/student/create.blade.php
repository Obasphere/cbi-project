...
<form method="post" action="{{route('student.store')}}">
	...
	<div class="col-md-6 col-lg-6 col-sm-6 col-lg-offset-3">
	  <div class="form-group">
	    ...
	    <input type="text" name="student_id" class="form-control " id="formGroupExampleInput" placeholder="example: 090591013 (Integer Only)" required>
	  </div>
	  <div class="form-group">
	    <label class="col-form-label" for="formGroupExampleInput2">Test PIN</label>
	    <input type="text" name="exam_code" class="form-control" id="formGroupExampleInput2" placeholder="The Test PIN issued by your Teacher" required>
	  </div>
