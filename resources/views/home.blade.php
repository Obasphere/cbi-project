        ...
        <div id="collapse1" class="panel-collapse collapse">
            ...
            allowfullscreen>
                ...
                <div class="embed-responsive embed-responsive-4by3">
                    <iframe class="embed-responsive-item" src="{{URL::asset("video/Computer Ethics.mp4")}}" allowfullscreen></iframe>
                </div>
    ...
    <div class="panel panel-primary" id="primary">
        ...
        <div id="collapse2" class="panel-collapse collapse">
            ...
            allowfullscreen>
                ...
                <div class="embed-responsive embed-responsive-4by3">
                    <iframe class="embed-responsive-item" src="{{URL::asset("video/Internet.mp4")}}" allowfullscreen></iframe>
                </div>
    ...
    <div class="panel panel-primary" id="primary">
        ...
        <div id="collapse3" class="panel-collapse collapse">
            ...
            allowfullscreen>
                ...
                <div class="embed-responsive embed-responsive-4by3">
                    <iframe class="embed-responsive-item" src="{{URL::asset("video/Safety Measures.mp4")}}" allowfullscreen></iframe>
                </div>
                <br>
